...
import { collection, deleteDoc, doc, getDoc, getDocs, getFirestore, onSnapshot, setDoc } from 'https://www.gstatic.com/firebasejs/10.12.0/firebase-firestore.js';
...
async function fbLoad() {
  ...
  const timeout = setTimeout(() => {
    console.warn('Firebase timeout — abrindo sem dados');
    showLoading(false);
    setOnline(false);
    initUI();
  }, 8000);
